...
ActiveRecord::Schema.define(version: 20160318190739) do
  ...
  add_index "property_availabilities", ["property_id"], name: "index_property_availabilities_on_property_id", using: :btree
